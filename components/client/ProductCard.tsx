...
export default function ProductCard({ product }: { product: ApiProduct }) {
  ...
  // Example original price (you might store discount/compareAt price in backend)
  const originalPrice =
    price > 0 ? price + 100 : undefined; // Just demo, adjust as needed

  // Example rating (until API supports it)
  const rating = 4.5;
    ...
    >
      ...
      <div className="relative aspect-square w-full overflow-hidden bg-gray-100">
        ...
        >
          <Button
            variant="ghost"
            className="w-full flex items-center justify-center gap-2 text-white hover:bg-black/90"
          >
